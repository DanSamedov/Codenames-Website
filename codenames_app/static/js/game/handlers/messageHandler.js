class GameMessageHandler {
    ...
    handleHintDisplay(data) {
        ...
        this.storageManager.setHintData(this.gameState.hintWord, this.gameState.hintNum);
        this.uiManager.updateHintDisplay(this.gameState.hintWord, this.gameState.hintNum);
    }
    ...
    handleSyncTime(data) {
        ...
        if (storedHintData.hintNum && this.gameState.phase === window.GameConstants.PHASES.ROUND_PHASE) {
            this.uiManager.updateHintDisplay(storedHintData.hintWord, storedHintData.hintNum);
        } else {
            this.uiManager.clearHintDisplay();
        }
